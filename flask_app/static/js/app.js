...
productButton.addEventListener("click", () => {
  ...
  payment.querySelector(".modelBuy").value = currentProductTitle.textContent;
  console.log(currentProductColor)
  // console.log(currentProductSize.textContent)
  payment.querySelector(".sizeBuy").value = currentProductSize.textContent;
  payment.querySelector(".colorBuy").value = currentProductColor;
